...
class HardWords extends React.Component {
    ...
    componentWillReceiveProps(nextProps, nextContext) {
        if (nextProps.history.location.search) {
            ...
            this.setState({
                activeTab: parseInt(searchObj.year, 10)
            });
    ...
    componentDidMount() {
        console.log('mount hardword');
    }

    componentWillUnmount() {
        console.log('unmount hardword');
    }
    ...
    getData(ev, year, month) {
        axios
            .get(links.serverLink + 'trendywords/' + year + '/' + month)
    ...
    render() {
        return (
            <div>
                <Typography variant="h4" style={headCss}>Difficult Words</Typography>
